...
Note that this software is distributed in accordance to the MPL licence. However
it is possible to redistribute the software as GPL or LGPL licensed code.
...
Some of the information mentioned is also maintained in the project wiki. At the
moment it is not easy to tell which info is the newest one, but a more formal
procedure for wiki and .txt updating will hopefully be in place some day.