...
void sg_viewport_reshape(sg_viewport_t *viewport, unsigned x, unsigned y,
                         unsigned w, unsigned h);
...
sg_scene_t* sg_viewport_get_scene(sg_viewport_t *vp);

int sg_viewport_get_width(sg_viewport_t *vp);
int sg_viewport_get_height(sg_viewport_t *vp);
