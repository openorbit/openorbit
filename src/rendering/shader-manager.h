...
void sg_shader_set_projection(sg_shader_t *shader, const double4x4 proj);
void sg_shader_set_model_view(sg_shader_t *shader, const double4x4 proj);
void sg_shader_set_normal_matrix(sg_shader_t *shader, const double4x4 norm);
